...
// runFileDebug runs a file with interactive CLI debugger
func runFileDebug(filename string) {
	...
	// For simplicity, skip full type checking in debug mode for now
	// In production, you'd want to do the full type checking like runFile does
